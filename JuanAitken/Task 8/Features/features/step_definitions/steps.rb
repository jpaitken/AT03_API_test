# Given(/^I am in Google Main page$/) do          -----> Regular expression
#   puts "You are on Google main page"            ------> Ruby code
# end
#
...
#The feature file still working after the keywords have been changed